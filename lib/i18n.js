...
const resources = {
  en: {
    ...
    alreadyLatest: "You're already up to date!",
    needUpdate: "Update available ({0} change)",
    majorUpdate: "major",
    minorUpdate: "minor",
    patchUpdate: "patch",
    runCliAfterUpdate: "Update successful, run CLI now?"
  },
  zh: {
    usage: "用法",
    options: "选项",
    ...
    alreadyLatest: "很不错，你已经保持了最新",
    needUpdate: "需要更新（{0} 变更）",
    majorUpdate: "重大",
    minorUpdate: "次要",
    patchUpdate: "补丁",
    runCliAfterUpdate: "更新成功，是否立即运行 CLI？"
  }
};
